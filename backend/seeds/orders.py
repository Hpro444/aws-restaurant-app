...
def seed(dynamodb, tables: dict, context: dict) -> None:
    """Seed demo orders linked to active and reserved reservations.

    Creates one order per IN_PROGRESS reservation and one for the first
    RESERVED reservation, using dishes from context. Requires
