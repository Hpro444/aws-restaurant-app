export default  {
  ...
  label: "font-medium text-sm leading-6 text-[var(--color-text-primary)]",
  input:
    "w-60 h-14 rounded-lg border border-[var(--color-border-default)] p-4 gap-2 bg-[var(--color-surface)] focus:border-[var(--color-brand)] focus:ring-1 focus:ring-[var(--color-brand)] focus:outline-none",
  ...
  actionWrap: "mt-2 flex flex-col gap-4",
};